...
class InteractionUI:
    ...
    def setup_ui(self):
        ...
        # Φόρμα για την περιγραφή της εμπειρίας
        ...
        # Dropdown για να επιλέξει το ταξίδι
        ...
        # Φόρμα για να προσθέσει φωτογραφίες
        ...
        # Φορτώνουμε τα ταξίδια του χρήστη στο dropdown
    ...
    def load_user_trips(self):
        ...
        # Γεμίζουμε το dropdown με τα ταξίδια
        trip_names = [f"{trip[1]} (ID: {trip[0]})" for trip in trips]
        self.trip_dropdown['values'] = trip_names
        if trips:
            self.trip_dropdown.set(trip_names[0])  # Ορισμός προεπιλεγμένης επιλογής
    ...
    def share_experience(self):
        ...
        # Λαμβάνουμε το trip_id από το επιλεγμένο ταξίδι
        selected_trip = self.trip_dropdown.get()
        trip_id = int(selected_trip.split('(')[1].split(')')[0])  # Αποσπάμε το trip_id
    ...
    def report_post(self):
        post_id = int(self.content_entry.get())  # Προσωρινή χρήση input
